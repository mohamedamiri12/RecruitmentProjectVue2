<template>
  <CCol md="12">
    <CCard>
      <CCardHeader>
        <strong>Edit Candidate Profil</strong>
      </CCardHeader>
      <CCardBody>
        <div
...
export default {
  ...
  computed: {
    ...
    status() {
      return this.candidate.is_suspended === 0 ? false : true;
    },
  },
  methods: {
    countDownTimer() {
    ...
    uploadImage(e) {
      this.candidate_image = e.target.files[0];
    ...
    updateCandidate() {
      ...
      updatedCAndidate.append("last_name", this.candidate.last_name);
      updatedCAndidate.append("email", this.candidate.email);
      updatedCAndidate.append("password", this.candidate);
      updatedCAndidate.append("phone_number", this.candidate.phone_number);
      updatedCAndidate.append("candidate_image", this.candidate_image);
      updatedCAndidate.append("_method", "PUT");
